...
// The site BASE URL (with trailing slash)
...
if (!defined('HGPHP_OK')) {
    define('HGPHP_OK', 0);
    define('HGPHP_ERR_PERM_USR', -1);
    define('HGPHP_ERR_PERM_SYS_REPODIR', -3);
    define('HGPHP_ERR_PERM_SYS_TMPFILE', -4);
    define('HGPHP_ERR_FS_PREEXISTS', -5);
    define('OFL_ERR_READING', -6);
    define('OFL_ERR_WRITING', -7);
    define('OFL_ERR_NOTEXISTS_OR_PERM', -8);
    define('OFL_ERR_LOCKING', -9);

    define('HGPHP_REPO_STATUS_ENABLED', 1);
